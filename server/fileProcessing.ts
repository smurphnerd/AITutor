...
async function processPdf(filePath: string) {
  ...
  try {
    ...
    // For MVP, we'll use OpenAI to extract and analyze the PDF content
    // This simplifies our implementation and avoids PDF parsing issues
    
    // Convert PDF to base64
    const base64PDF = dataBuffer.toString('base64');
    
    // Use OpenAI to extract text and identify images
